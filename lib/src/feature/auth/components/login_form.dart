...
import 'package:sample/src/feature/widgets/app_primary_button.dart';
import 'package:sample/src/feature/widgets/app_text_field.dart';
...
class _LoginFormState extends State<LoginForm> {
  ...
  Widget build(BuildContext context) => BlocBuilder<AuthBloc, AuthState>(
    builder: (context, state) {
      ...
      final isFormValid = state is AuthIdle && state.isFormValid;
      ...
      return Column(
        ...
        children: [
          ...
          AppPrimaryButton(
            ...
            onPressed: isFormValid && !isSubmitting ? _submit : null,
