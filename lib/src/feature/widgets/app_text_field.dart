  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      if (widget.labelsText.isNotEmpty)
        Text(
          " ${widget.labelsText}",
          style: context.smallText(weight: 520),
      ...
      Form(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            errorMaxLines: 3,
            errorStyle: StyleManager.styleText(
              fXSmall12,
              color: context.colors.cBtnSell,
              height: 1.4,
            ),
            ...
            focusedErrorBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(color: context.colors.cBtnSell),
            ),
            ...
            focusedBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(
                color: widget.borderColor ?? context.colors.cBtnPrimary,
              ),
            ),
            suffixIcon: Row(
            ...
            prefixIcon: widget.leftWidget?.marginOnly(
              left: _paddingSide,
              right: 6,
            ),
