...
class TokenPreferences {
  ...
  static Future<void> setAccessToken(String value) async =>
      _secure.write(key: PreferencesKeys.accessToken, value: value);
  static Future<String?> accessToken() async =>
      _secure.read(key: PreferencesKeys.accessToken);

  static Future<void> setRefreshToken(String value) async =>
      _secure.write(key: PreferencesKeys.refreshToken, value: value);
  ...
  static int expiresIn() =>
      _box.get(PreferencesKeys.expiresIn, defaultValue: 0) as int;
  ...
  static int refreshExpiresIn() =>
      _box.get(PreferencesKeys.refreshExpiresIn, defaultValue: 0) as int;

  static Future<void> setTokenObtainedAt(int value) =>
      _box.put(PreferencesKeys.tokenObtainedAt, value);
  static int tokenObtainedAt() =>
      _box.get(PreferencesKeys.tokenObtainedAt, defaultValue: 0) as int;
}
