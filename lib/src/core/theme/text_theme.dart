...
extension TextStylesExtension on BuildContext {
  ...
  TextStyle mediumText({
    ...
    this,
  ).textStyle(height: height, weight: weight, width: width);
  ...
  TextStyle mediumBrand2({
    ...
    this,
  ).textStyle(tone: Tone.brand, height: height, weight: weight, width: width);
  ...
  TextStyle mediumActive({
    ...
    this,
  ).textStyle(tone: Tone.active, height: height, weight: weight, width: width);
  ...
  TextStyle mediumRed({
    ...
    this,
  ).textStyle(tone: Tone.sell, height: height, weight: weight, width: width);
  ...
  TextStyle mediumGreen({
    ...
    this,
  ).textStyle(tone: Tone.buy, height: height, weight: weight, width: width);
